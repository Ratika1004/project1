...
const createGroceryRules = [
  body("name").notEmpty().isString().isLength({ min: 1 }).withMessage("Name is required and must be at least 1 character long"),
  body("quantity").notEmpty().isInt({ gt: 0 }).withMessage("Quantity is required and must be a positive integer"),
